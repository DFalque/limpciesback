const config = {
  ...
  translations: {
    en: 
    {
      ...
      "Media Library": "Archivos (Imágenes, Videos y Documentos)",
      ...
      "admin.pages.MarketPlacePage.helmet": "Marketplace - Extensiones",
      ...
      "app.components.LeftMenuLinkContainer.collectionTypes": "Colecciones",
      ...
      "content-manager.components.DynamicZone.error-message": "El componente contiene errore(s)",
      "content-manager.components.DynamicZone.missing-components": "Hay {number, plural, =0 {# componentes faltantes} one {# componente faltante} other {# componentes faltantes}}",
      "content-manager.components.DynamicZone.move-down-label": "Mover componente hacia abajo",
      "content-manager.components.DynamicZone.move-up-label": "Mover componente hacia arriba",
      "content-manager.components.DynamicZone.pick-compo": "Elija un componente",
      "content-manager.components.DynamicZone.required": "Se requiere un componente",
      "content-manager.components.EmptyAttributesBlock.button": "Ir a la página de configuraciones",
      "content-manager.components.EmptyAttributesBlock.description": "Usted puede cambiar sus configuraciones",
      "content-manager.components.FieldItem.linkToComponentLayout": "Establecer el diseño del componente",
      ...
      "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Limpiar todo",
      "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Establece las condiciones a aplicar para filtrar registros",
      ...
      "content-manager.components.LeftMenu.Search.label": "Buscar un tipo de contenido",
      "content-manager.components.LeftMenu.collection-types": "Colecciones",
      "content-manager.components.LeftMenu.single-types": "Componentes",
      "content-manager.components.LimitSelect.itemsPerPage": "registros por página",
      "content-manager.components.NotAllowedInput.text": "Sin permisos para ver este campo",
      "content-manager.components.RepeatableComponent.error-message": "Los componentes contienen errores",
      ...
      "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Personaliza cómo se verá la vista de edición.",
      "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Defina la configuración de la vista de lista.",
      ...
      "content-manager.components.TableDelete.deleteSelected": "Eliminar seleccionados",
      "content-manager.components.TableDelete.label": "{number, plural, one {# entrada seleccionada} other {# entradas seleccionads}}",
      "content-manager.components.TableEmpty.withFilters": "No hay {contentType} con los filtros aplicados...",
      "content-manager.components.TableEmpty.withSearch": "No hay {contentType} que coincida con la búsqueda ({search})...",
      "content-manager.components.TableEmpty.withoutFilter": "No hay {contentType}...",
      "content-manager.components.empty-repeatable": "Aún no hay entrada. Haga clic en el botón de abajo para agregar uno.",
      "content-manager.components.notification.info.maximum-requirement": "Ya has alcanzado el número máximo de campos",
      "content-manager.components.notification.info.minimum-requirement": "Se ha agregado un campo para cumplir con el requisito mínimo",
      "content-manager.components.repeatable.reorder.error": "Se produjo un error al reordenar el campo de su componente. Vuelva a intentarlo.",
      ...
      "content-manager.containers.Edit.information.draftVersion": "versión preliminar",
      "content-manager.containers.Edit.information.editing": "Edición",
      "content-manager.containers.Edit.information.lastUpdate": "Última actualización",
      "content-manager.containers.Edit.information.publishedVersion": "versión publicada",
      ...
      "content-manager.containers.EditSettingsView.modal-form.edit-field": "Edita el campo",
      "content-manager.containers.EditView.add.new-entry": "Agregar una entrada",
      "content-manager.containers.EditView.notification.errors": "El formulario contiene algunos errores",
      "content-manager.containers.Home.introduction": "Para editar sus registros vaya al link en específico en el menu de la izquierda. Este plugin no tiene una manera de editar configuraciones y aún esta en continuo desarrollo.",
      "content-manager.containers.Home.pluginHeaderDescription": "Gestiona sus registros en una bella y poderoza interfaz.",
      ...
      "content-manager.containers.SettingPage.attributes.description": "Defina el orden de sus atributos",
      "content-manager.containers.SettingPage.editSettings.description": "Arrastra y suelta los campos para construir el diseño",
      "content-manager.containers.SettingPage.editSettings.entry.title": "Título de la entrada",
      "content-manager.containers.SettingPage.editSettings.entry.title.description": "Establece el campo para mostar en tu entrada",
      "content-manager.containers.SettingPage.editSettings.relation-field.description": "Establece el campo mostrado en las vistas de lista y edición",
      "content-manager.containers.SettingPage.editSettings.title": "Editar (configuraciones)",
      "content-manager.containers.SettingPage.layout": "Layout",
      "content-manager.containers.SettingPage.listSettings.description": "Configure las opciones para este Tipo de Colección",
      "content-manager.containers.SettingPage.listSettings.title": "Lista (configuraciones)",
      "content-manager.containers.SettingPage.pluginHeaderDescription": "Configure los ajustes específicos para este Tipo de Colección",
      "content-manager.containers.SettingPage.settings": "Ajustes",
      "content-manager.containers.SettingPage.view": "Ver",
      "content-manager.containers.SettingViewModel.pluginHeader.title": "Administrador de contenido - {name}",
      "content-manager.containers.SettingsPage.Block.contentType.description": "Configuraciones específicas",
      "content-manager.containers.SettingsPage.Block.contentType.title": "Colecciones",
      "content-manager.containers.SettingsPage.Block.generalSettings.description": "Configure las opciones predeterminadas para sus Tipos de Colección",
      "content-manager.containers.SettingsPage.Block.generalSettings.title": "General",
      "content-manager.containers.SettingsPage.pluginHeaderDescription": "Configure los ajustes para todos sus Tipos y Grupos de Colecciones",
      "content-manager.containers.SettingsView.list.subtitle": "Configure el diseño y la visualización de sus Tipos y Grupos de Colecciones",
      "content-manager.containers.SettingsView.list.title": "Configuraciones de pantalla",
      "content-manager.edit-settings-view.link-to-ctb.components": "Edita el componente",
      "content-manager.edit-settings-view.link-to-ctb.content-types": "Edita el tipo de contenido",
      "content-manager.emptyAttributes.button": "Ir al constructor de Tipo de Colección",
      "content-manager.emptyAttributes.description": "Agregue su primer campo a su Tipo de Colección",
      ...
      "content-manager.error.model.fetch": "Ocurrió un error durante la consulta de configuración de modelos.",
      "content-manager.error.record.create": "Ocurrió un error durante la creación del registro.",
      "content-manager.error.record.delete": "Ocurrió un error durante la eliminación del registro.",
      "content-manager.error.record.fetch": "Ocurrió un error durante la consulta del registro.",
      "content-manager.error.record.update": "Ocurrió un error durante la actualización del registro.",
      "content-manager.error.records.count": "Ocurrió un error durante la consulta del número de registros.",
      "content-manager.error.records.fetch": "Ocurrió un error durante la consulta de registros.",
      "content-manager.error.schema.generation": "Ocurrió un error durante la generación de esquema.",
      ...
      "content-manager.error.validation.regex": "El valor no cumple la expresión regular.",
      ...
      "content-manager.form.Input.description.placeholder": "Mostrar nombre en el perfíl",
      ...
      "content-manager.form.Input.label.inputDescription": "Este valor sobrescribe la etiqueta mostrada en la cabecera de la tabla",
      "content-manager.form.Input.pageEntries": "Entradas por página",
      "content-manager.form.Input.pageEntries.inputDescription": "Nota: Puede anular este valor en la página de configuración de Tipo de Colección.",
      ...
      "content-manager.form.Input.search.field": "Habilitar la búsqueda para este campo",
      ...
      "content-manager.models": "Colecciones",
      "content-manager.models.numbered": "Tipos de Colección ({number})",
      "content-manager.notification.error.displayedFields": "Usted necesita al menos un campo mostrado",
      "content-manager.notification.error.relationship.fetch": "Ocurrió un error durante la consulta de la relación.",
      "content-manager.notification.info.SettingPage.disableSort": "Necesita tener un habilidato el ordenado en un atributo",
      "content-manager.notification.info.minimumFields": "Debe tener al menos un campo mostrado",
      "content-manager.notification.upload.error": "Se produjo un error al subir sus archivos",
      "content-manager.pageNotFound": "Página no encontrada",
      "content-manager.pages.ListView.header-subtitle": "{number, plural, =0 {# entradas encontradas} one {# entrada encontrada} other {# entradas encontradas}}",
      "content-manager.pages.NoContentType.button": "Crea tu primer tipo de contenido",
      "content-manager.pages.NoContentType.text": "Aún no tiene ningún contenido, le recomendamos que cree su primer tipo de contenido.",
      "content-manager.permissions.not-allowed.create": "No se le permite crear un documento",
      "content-manager.permissions.not-allowed.update": "No se le permite ver este documento",
      "content-manager.plugin.description.long": "Ver, editar y eliminar información de su base de datos de manera rápida.",
      "content-manager.plugin.description.short": "Ver, editar y eliminar información de su base de datos de manera rápida.",
      ...
      "content-manager.utils.data-loaded": "{number, plural, =1 {La entrada se ha cargado correctamente} other {Las entradas se han cargado correctamente}}",
      "content-manager.popUpWarning.warning.publish-question": "¿Aún quieres publicarlo?",
      "content-manager.popUpwarning.warning.has-draft-relations.button-confirm": "Si, publicar",
      ...
      "app.components.LeftMenu.navbrand.title": "Limpiezas Cíes",
      "app.components.LeftMenu.navbrand.workplace": "Bienvenido",
      ...
      "global.content-manager": "Administrar Página Web",
      ...
      "global.marketplace": "Tienda de extensiones",
      "global.name": "Nombre",
      "global.none": "Ninguno",
      "global.password": "Contraseña",
      "global.plugins": "Extensiones",
      "global.plugins.content-manager": "Administrar Página Web",
      ...
      "global.plugins.upload": "Archivos (Imágenes, Videos y Documentos)",
    ...
    es:{
      ...
      "global.enabled": "Habilitado",
      "global.finish": "Terminar",
      "global.marketplace": "Tienda de Aplicaciones",
      "global.name": "Nombre",
      "global.none": "Ninguno",
      "global.password": "Contraseña",
      "global.plugins": "Extensiones",
