...
export interface ApiNavNav extends Schema.SingleType {
  ...
  info: {
    singularName: 'nav';
    pluralName: 'navs';
    displayName: 'Navegaci\u00F3n Principal';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    Redirecciona: Attribute.Relation<
      'api::nav.nav',
      'oneToOne',
      'api::pagina.pagina'
    >;
...
export interface ApiPieDePaginaPieDePagina extends Schema.SingleType {
  collectionName: 'pie_de_paginas';
  info: {
    singularName: 'pie-de-pagina';
    pluralName: 'pie-de-paginas';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::pie-de-pagina.pie-de-pagina',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
